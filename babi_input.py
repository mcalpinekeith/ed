...
def get_babi_raw(id, test_id):
    ...
    babi_train_raw = init_babi(r'D:\babi\en-10k\%s_train.txt' % babi_name)
    babi_test_raw = init_babi(r'D:\babi\en-10k\%s_test.txt' % babi_test_name)
...
def load_glove(dim):
    ...
    print("==> loading glove")
    with open(r"D:\glove.6B." + str(dim) + "d.txt", encoding="utf") as f:
        for line in f:    
            l = line.split()
